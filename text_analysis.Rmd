...
bind_rows(afinn_Christmas, 
  ...
  theme_bw()
```
Figure 1 is the sentiment progress for every 80 lines in this book with different books.
...
Figure 3 displays word cloud where we can get the frequency for top 100 words with the size representing the word count. As is shown in the figure, "Scrooge", the leading character in this book, is the most common word by bing lexicon, which makes sense in this case. And the "Christmas", "ghost" and "spirit" follow after, which represent the period of time, objects talking about in the main plotline. the It is reasonable because they are the main characters in that fiction book. And we can also find "Bob", another main character in this fiction, which I will do the character analysis along with Scrooge.
