...
```{r}
tnBooksFromLines(Christmas_df$text, "Charlse_Dickens/A_Christmas_Carol")
q20<-tnum.query(query="Charlse_Dickens/A_Christmas_Carol# has *",max=100000)
